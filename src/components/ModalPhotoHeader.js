...
const ModalPhotoHeader = props => {
  ...
  const {
    ...
    leftViewTextStyle = null, //왼쪽 텍스트 스타일
    rightViewStyle = null, //오른쪽 텍스트 뷰 스타일
    rightViewTextStyle = null, // 오른쪽 텍스트 스타일
  } = props;
    ...
    <View style={[styles.HeaderConteiner, HeaderConteiner]}>
      ...
      <View style={{alignItems: 'flex-end'}}>
        <TouchableOpacity
          ...
          <Text style={[styles.rightViewTextStyle, rightViewTextStyle]}>
            확인
          </Text>
        </TouchableOpacity>
      </View>
...
export default ModalPhotoHeader;
